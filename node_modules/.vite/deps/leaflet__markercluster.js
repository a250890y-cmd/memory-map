...
var require_leaflet_markercluster_src = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(global, factory) {
			...
			*/
			...
			_recursivelyAnimateChildrenIn: function(bounds, center, maxZoom) {
				this._recursively(bounds, this._group._map.getMinZoom(), maxZoom - 1, function(c) {
					var markers = c._markers, i = markers.length - 1, m;
					for (; i >= 0; i--) {
						m = markers[i];
						if (m._icon) {
							m._setPos(center);
					...
					var childClusters = c._childClusters, j = childClusters.length - 1, cm;
					for (; j >= 0; j--) {
						cm = childClusters[j];
						if (cm._icon) {
							cm._setPos(center);
		...
		(function() {
			L.QuickHull = {
				...
				findMostDistantPointFromBaseLine: function(baseLine, latLngs) {
					var maxD = 0, maxPt = null, newPoints = [], i = latLngs.length - 1, pt, d;
					for (; i >= 0; i--) {
						pt = latLngs[i];
				...
				getConvexHull: function(latLngs) {
					var maxLat = false, minLat = false, maxLng = false, minLng = false, maxLatPt = null, minLatPt = null, maxLngPt = null, minLngPt = null, maxPt = null, minPt = null, i = latLngs.length - 1;
					for (; i >= 0; i--) {
						var pt = latLngs[i];
		...
		L.MarkerCluster.include({ getConvexHull: function() {
			var childMarkers = this.getAllChildMarkers(), points = [], p, i = childMarkers.length - 1;
			for (; i >= 0; i--) {
